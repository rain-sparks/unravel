            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions mr-1">
                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="users">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$item->price}}</td>
                            <td>
                            <a href='/products/view/{{$item->id}}' title='View' class='edit' id='{$row->id}'> <i class='la la-eye'></i></a>&nbsp;
                            <a href='/products/edit/{{$item->id}}' title='Edit' class='edit' id='{$row->id}'> <i class='la la-edit'></i></a>&nbsp;
                            <a href="{{route('products.delete',$item->id)}}" title='Delete' class='edit' id='{$row->id}'> <i class='la la-trash'></i></a>&nbsp;
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
